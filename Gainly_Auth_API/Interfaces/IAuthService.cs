...
namespace Gainly_Auth_API.Interfaces
{
    public interface IAuthService
    {
        ...
        /// <summary>
        /// Проверяет  код подтверждения на e-mail.
        /// </summary>
        Task<EmailCodeResult> CheckEmailCodeAsync(CheckEmailDto dto, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<AuthResult> TGLoginRawAsync(TelegramInitDataRawDto initdata, CancellationToken cancellationToken = default);
        Task<AuthResult> TGLoginAsync(TelegramInitDataDto request, CancellationToken cancellationToken = default);
    ...
    public record EmailCodeResult(bool IsValid, string? ErrorMessage);
}
